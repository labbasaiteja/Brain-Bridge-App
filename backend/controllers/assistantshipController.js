...
exports.createAssistantship = async (req, res) => {
...
exports.getProfessorAssistantships = async (req, res) => {
  if (req.user.role !== 'professor')
...
exports.getAssistantshipDetailsProf = async (req, res) => {
  if (req.user.role !== 'professor') {
...
exports.updateAssistantship = async (req, res) => {
  if (req.user.role !== 'professor') {
...
exports.deleteAssistantship = async (req, res) => {
  if (req.user.role !== 'professor') {
...
exports.searchAssistantships = async (req, res) => {
  if (req.user.role !== 'professor') {
...
exports.searchAssistantshipsStu = async (req, res) => {
...
exports.getAssistantshipDetailsStu = async (req, res) => {
  if (req.user.role !== 'student') {
...
exports.getAllAssistantships = async (req, res) => {
  if (req.user.role !== 'student') {
